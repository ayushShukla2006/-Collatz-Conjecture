...
### Main Menu
Beautiful, intuitive menu with clearly labeled options.

### Visualizations
- Interactive matplotlib graphs
- Support for both normal and logarithmic scales
- Color-coded sequences for easy comparison
- Statistical information displayed with each visualization
